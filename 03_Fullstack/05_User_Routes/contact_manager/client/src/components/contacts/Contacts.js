// 7. Use rafcp to create a new bolierplate
...
// 9. Import our SingleContact.js
import SingleContact from './SingleContact';
// 10. import our getContacts action from our action file
import { getContacts } from '../../actions/contactActions';

// 11. we can copy our return code from our .bak version of Contacts.js
// we can also destructure our props here too.
const Contacts = ({getContacts, loading, contacts}) => {
  // 15. create a useEffect hook to use our getContacts function.
  useEffect(() => {
    getContacts();
  }, [getContacts]);

  // 16. open SingleContact.js
  return loading ? (
    <h1> loading....</h1>
    ) : (<div className='mt-3'>
...
// 12. We can define props that our component will get.
...
// 13. The export will need to wrapped with a connect function.
