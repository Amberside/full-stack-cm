...
// 47. Import propTypes and connect
import PropTypes from 'prop-types';
import { connect } from 'react-redux';
// 48. Import functions from our action file. getContact & updateContact
...
const EditContact = ({ 
  ...
  // 49. We need to change useEffect function to make use of our actions
...
// 50. Change the onSubmit to add in updateContact function;
  const onSubmit = async(e) => {
    ...
    // 51. change the call to our updateContact function
...
// 52. remove the return and value parts here. We only need the inner return and the code within it.
  return (
    <Fragment>
